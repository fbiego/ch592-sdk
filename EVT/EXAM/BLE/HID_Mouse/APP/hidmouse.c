/* ********************************* (C) COPYRIGHT ***************************
* File Name : hiddenmouse.c
* Author: WCH
* Version: V1.0
* Date: 2018/12/10
* Description: Bluetooth mouse application, initializes broadcast connection parameters, and then broadcasts until the host is connected, and the key value is uploaded regularly
************************************************************************************************************
