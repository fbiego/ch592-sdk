...
/* For the case where the chip with the user code area and the boot area, the operation target is the user code area,
It can be called in the user code (IAP, erase itself), or it can be called in the boot code (update the user code) */
